public class Enemy {
   ...
   public static Enemy getRandomEnemy() {
        ...
        enemies.add(new Enemy("Venom", 130, 130, 17, "Symbiote Strike - 25 damage", "Web Trap - 15 damage", "Rage - doubles attack", 25, 15, 20, 30, 20, 20, 100));         //arraylist of enemy characters for cpu/ai/bot
